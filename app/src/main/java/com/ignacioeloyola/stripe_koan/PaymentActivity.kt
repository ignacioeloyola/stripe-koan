...
import com.ignacioeloyola.stripe_koan.databinding.CartItemBinding
import com.ignacioeloyola.stripe_koan.databinding.PaymentActivityBinding
...
class PaymentActivity : AppCompatActivity() {
    ...
    private fun updateForGooglePay() {
        viewBinding.buttonAddPaymentMethod.text = getString(com.stripe.android.R.string.google_pay)
    }
